...
/**
 * Servlet implementation class UnverfiedPassengers
 */
@WebServlet("getUnverifiedPassengers")
public class UnverfiedPassengers extends HttpServlet {
	public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException {
		...
		passengers=dao.getUnverifiedPassengers(train_no, compartment);
		
		req.setAttribute("data", passengers);
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/unverified.jsp");
		try {
